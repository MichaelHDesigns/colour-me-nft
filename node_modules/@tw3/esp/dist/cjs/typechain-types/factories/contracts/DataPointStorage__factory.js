...
exports.DataPointStorage__factory = void 0;
...
class DataPointStorage__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.DataPointStorage__factory = DataPointStorage__factory;

...
export function loadContract(chainId, contract, provider = null) {
 ...
 */
export function addLocalhostDeployment(deploymentData, options = {}) {
 ...
 */
export function removeLocalhostDeployment(chainId) {
 ...
 */
export function hasLocalhostDeployment(chainId = 31337) {
    const deployments = _getDeployments();
